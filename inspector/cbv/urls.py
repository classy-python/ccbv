...
from cbv.views import KlassDetailView, ModuleDetailView, VersionDetailView

urlpatterns = patterns('',
	url(r'^(?P<package>[a-zA-Z_-]+)/(?P<version>[^/]+)/$', VersionDetailView.as_view(), name='module-detail'),
